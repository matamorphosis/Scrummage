...
def Call_Plugin(**kwargs):
    ...
    if kwargs["Plugin_Name"] == "YouTube Search":
        ...
        Thread_2.start()
        # YT_Search.Search(kwargs["Query"], Limit=kwargs["Limit"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # WS_Search.Search(kwargs["Query"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Twitter_Scrape.Search(kwargs["Query"], Limit=kwargs["Limit"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # RSS_Feed_Search.Search(kwargs["Query"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Reddit_Search.Search(kwargs["Query"], Limit=kwargs["Limit"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Phishtank_Search.Search(kwargs["Query"], Limit=kwargs["Limit"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # ITunes_Store_Search.Search(kwargs["Query"], Limit=kwargs["Limit"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Instagram_Search.Search(kwargs["Query"], Limit=kwargs["Limit"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Have_I_Been_Pwned.Search(kwargs["Query"], "breach", Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Have_I_Been_Pwned.Search(kwargs["Query"], "email", Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Google_Search.Search(kwargs["Query"], Limit=kwargs["Limit"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Google_Play_Store_Search.Search(kwargs["Query"], Limit=kwargs["Limit"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Ebay_Search.Search(kwargs["Query"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Domain_Fuzzer.Regular_Extensions(kwargs["Query"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Domain_Fuzzer.Global_Suffixes(kwargs["Query"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Domain_Fuzzer.Character_Switch(kwargs["Query"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Darkweb_Search.Search(kwargs["Query"], Task_ID=kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Craigslist_Search.Search(kwargs["Query"],)
        # Stopper(kwargs["Task_ID"])
        ...
        Thread_0.start()
        Thread_0.join()
        # Certificate_Transparency.Search(kwargs["Query"], Task_ID=kwargs["Task_ID"])
...
if __name__ == "__main__":
    ...
    Parser.add_argument('-t', '--task', help='This option is used to specify a task ID to run. ./Play_Store.py -t 1')
