    ...
    def Search(self):
        ...
        try:
            ...
            for Query in self.Query_List:
                ...
                Data = {"input": Query}
                Responses = Common.Request_Handler(url=Search_URL, method="POST", Data=Data, Filter=True, Host=Search_URL)
                ...
                if "Invalid .ONION domain" not in Response:
                    ...
                    if Output_URL not in Cached_Data and Output_URL not in Data_to_Cache:
                        ...
                        if Output_file:
                            Output_Connections.Output([Output_file], Output_URL, f"Tor Whois | {Common.Fang().Defang(Query)}", self.Plugin_Name.lower())
