        ...
        try:
            ...
            for Query in self.Query_List:
                ...
                if Common.Regex_Handler(Query, Type="IP"):
                    Search_URL = f"https://www.{self.Domain}/w3m?action=checkblock&ip={Query}"
                    ...
                    if "not listed in bl.spamcop.net" not in Filtered_Response and Search_URL not in Cached_Data and Search_URL not in Data_to_Cache:
