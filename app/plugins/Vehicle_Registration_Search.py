...
class Plugin_Search:
    ...
    def __init__(self, Query_List, Task_ID):
        self.Plugin_Name = "Vehicle Registration"
        self.Concat_Plugin_Name = "vehicleregistration"
        ...
        self.Domain = "general-insurance.coles.com.au"
        self.Result_Type = "Vehicle Details"
        ...
        try:
            ...
            for Query in self.Query_List:
                ...
                for State in self.States:
                    ...
                    Registration_Response = Common.Request_Handler(Post_URL, Method="POST", Data=data, Optional_Headers=headers)
