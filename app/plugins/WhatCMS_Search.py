...
class Plugin_Search:
    ...
    def __init__(self, Query_List, Task_ID):
        self.Plugin_Name = "WhatCMS"
        self.Logging_Plugin_Name = General.Get_Plugin_Logging_Name(self.Plugin_Name)
        self.Task_ID = Task_ID
        self.Query_List = General.Convert_to_List(Query_List)
        self.The_File_Extensions = {"Main": ".json", "Query": ".html"}
        self.Domain = "whatcms.org"
    ...
    def Search(self):
        ...
        try:
            ...
            for Query in self.Query_List:
                ...
                Response = Common.Request_Handler(Search_URL)
                JSON_Object = Common.JSON_Handler(Response)
                JSON_Response = JSON_Object.To_JSON_Loads()
                JSON_Output_Response = JSON_Object.Dump_JSON()
                HTML_Responses = Common.Request_Handler(HTML_URL, Filter=True, Host=f"https://{self.Domain}")
